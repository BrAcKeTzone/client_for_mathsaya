...
async function fetchStudentProfile() {
  ...
  if (studentProfile) {
    ...
    try {
      ...
      console.log(studentData.studentProfile.userId);
...
export default class PlayGame extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("playLogo", play);
    this.load.image("profileLogo", profileLogo);
  ...
  createProfileButton(audioState) {
    ...
    const profileButton = this.add
      .image(width / 4, height / 2 + 100, "profileLogo")
      .setInteractive();
  ...
  createPlayButton(audioState) {
    ...
    const playButton = this.add
      .image(width / 2, height / 2 + 100, "playLogo")
      .setInteractive();
